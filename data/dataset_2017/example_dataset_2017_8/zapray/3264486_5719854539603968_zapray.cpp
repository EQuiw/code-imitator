...
void output(int n) {
	...
	for (int i = 1; i <= n; i++)
		for (int j = 1; j <= n; j++) {
			if (B[i][j] == '+' || B[i][j] == 'T') score += 1;
			if (B[i][j] == 'x' || B[i][j] == 'X') score += 1;
			if (B[i][j] == 'o' || B[i][j] == 'O') score += 2;

			if (B[i][j] == 'T' || B[i][j] == 'X' || B[i][j] == 'O') changed += 1;
		}
	printf("%d %d\n", score, changed);
	for (int i = 1; i <= n; i++)
		for (int j = 1; j <= n; j++) {
		...
		do {
			...
			for (int i = 1; i <= n; i++)
				for (int j = 1; j <= n; j++) {
					int u = i + j;
					int v = i - j + n;
					if (B[i][j] == 'x' || B[i][j] == 'X' || B[i][j] == 'o' || B[i][j] == 'O') {
						killedi[i] += 1;
						killedj[j] += 1;
					}
					if (B[i][j] == '+' || B[i][j] == 'T' || B[i][j] == 'o' || B[i][j] == 'O') {
						killedu[u] += 1;
						killedv[v] += 1;
					}
				}
			...
			for (int i = 1; i <= n; i++)
				for (int j = 1; j <= n; j++) {
					...
					int v = i - j + n;
					if (B[i][j] == 0) {
						if (killedi[i] == 0 && killedj[j] == 0 && killedu[u] == 0 && killedv[v] == 0)
							candidates.emplace(i, j);
					}
					else if (((B[i][j] == 'x' || B[i][j] == 'X') && (killedu[u] == 0 && killedv[v] == 0))
						|| ((B[i][j] == '+' || B[i][j] == 'T') && (killedi[i] == 0 && killedj[j] == 0))) {
						candidates.emplace(i, j);
					}
