...
int main(int argc, const char * argv[]) {
    freopen("/Users/iwaisatoshi/Dropbox/17Todai/CodeJam/Qual2017-C/in.txt","r",stdin);
    freopen("/Users/iwaisatoshi/Dropbox/17Todai/CodeJam/Qual2017-C/out.txt","w",stdout);
    int t;
    scanf("%d",&t);
