...
int main(int argc, const char * argv[]) {
    freopen("/Users/iwaisatoshi/Dropbox/17Todai/CodeJam/R1A-2017-A/in.txt","r",stdin);
    freopen("/Users/iwaisatoshi/Dropbox/17Todai/CodeJam/R1A-2017-A/out.txt","w",stdout);
    int t;
    scanf("%d",&t);
